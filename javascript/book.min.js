...
(function(b,c,d,e){function f(n,v,x){return setTimeout(m(n,x),v)}function g(n,v,x){return Array.isArray(n)?(h(n,x[v],x),!0):!1}function h(n,v,x){var B;if(n)if(n.forEach)n.forEach(v,x);else if(n.length!==e)for(B=0;B<n.length;)v.call(x,n[B],B,n),B++;else for(B in n)n.hasOwnProperty(B)&&v.call(x,n[B],B,n)}function k(n,v,x){var B="DEPRECATED METHOD: "+v+"\n"+x+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,v,x){v=v.prototype;var B=n.prototype=Object.create(v);B.constructor=n;B._super=v;x&&X(B,x)}function m(n,v){return function(){return n.apply(v,arguments)}}function q(n,v){return"function"==typeof n?n.apply(v?v[0]||e:e,v):n}function p(n,v,x){h(r(v),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,x,!1):n.attachEvent(B,x)})}
function y(n,v,x){h(r(v),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,x,!1):n.detachEvent(B,x,!1)})}function u(n,v){for(;n;){if(n==v)return!0;n=n.parentNode}return!1}function r(n){return n.trim().split(/\s+/g)}function t(n,v,x){if(n.indexOf&&!x)return n.indexOf(v);for(var B=0;B<n.length;){if(x&&n[B][x]==v||!x&&n[B]===v)return B;B++}return-1}function w(n){return Array.prototype.slice.call(n,0)}function z(n,v,x){for(var B=[],C=[],E=0;E<n.length;){var G=v?n[E][v]:n[E];
0>t(C,G)&&B.push(n[E]);C[E]=G;E++}x&&(B=v?B.sort(function(L,T){return L[v]>T[v]}):B.sort());return B}function A(n,v){if(v&&v[0]){for(var x,B=v[0].toUpperCase()+v.slice(1),C=0;C<sa.length;){x=(x=sa[C])?x+B:v;if(x in n)return x;C++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function D(n,v){var x=this;this.manager=n;this.callback=v;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){q(n.options.enable,[n])&&x.handler(B)};this.init()}
function M(n,v,x){var B=x.pointers.length,C=x.changedPointers.length;var E=v&1&&0===B-C;x.isFirst=!!E;x.isFinal=!!(v&12&&0===B-C);E&&(n.session={});x.eventType=v;v=n.session;B=x.pointers;C=B.length;v.firstInput||(v.firstInput=K(x));1<C&&!v.firstMultiple?v.firstMultiple=K(x):1===C&&(v.firstMultiple=!1);E=v.firstInput;var G=(C=v.firstMultiple)?C.center:E.center;var L=x.center=H(B);x.timeStamp=qa();x.deltaTime=x.timeStamp-E.timeStamp;x.angle=J(G,L);x.distance=O(G,L);E=x.center;G=v.offsetDelta||{};L=
v.prevDelta||{};var T=v.prevInput||{};if(1===x.eventType||4===T.eventType)L=v.prevDelta={x:T.deltaX||0,y:T.deltaY||0},G=v.offsetDelta={x:E.x,y:E.y};x.deltaX=L.x+(E.x-G.x);x.deltaY=L.y+(E.y-G.y);x.offsetDirection=I(x.deltaX,x.deltaY);G=x.deltaTime;E=x.deltaX/G||0;G=x.deltaY/G||0;x.overallVelocityX=E;x.overallVelocityY=G;x.overallVelocity=ba(E)>ba(G)?E:G;C?(E=C.pointers,E=O(B[0],B[1],oa)/O(E[0],E[1],oa)):E=1;x.scale=E;C?(C=C.pointers,B=J(B[1],B[0],oa)+J(C[1],C[0],oa)):B=0;x.rotation=B;x.maxPointers=
v.prevInput?x.pointers.length>v.prevInput.maxPointers?x.pointers.length:v.prevInput.maxPointers:x.pointers.length;G=v.lastInterval||x;B=x.timeStamp-G.timeStamp;8!=x.eventType&&(25<B||G.velocity===e)?(E=x.deltaX-G.deltaX,G=x.deltaY-G.deltaY,L=E/B||0,T=G/B||0,B=L,C=T,L=ba(L)>ba(T)?L:T,E=I(E,G),v.lastInterval=x):(L=G.velocity,B=G.velocityX,C=G.velocityY,E=G.direction);x.velocity=L;x.velocityX=B;x.velocityY=C;x.direction=E;v=n.element;u(x.srcEvent.target,v)&&(v=x.srcEvent.target);x.target=v;n.emit("hammer.input",
x);n.recognize(x);n.session.prevInput=x}function K(n){for(var v=[],x=0;x<n.pointers.length;)v[x]={clientX:ea(n.pointers[x].clientX),clientY:ea(n.pointers[x].clientY)},x++;return{timeStamp:qa(),pointers:v,center:H(v),deltaX:n.deltaX,deltaY:n.deltaY}}function H(n){var v=n.length;if(1===v)return{x:ea(n[0].clientX),y:ea(n[0].clientY)};for(var x=0,B=0,C=0;C<v;)x+=n[C].clientX,B+=n[C].clientY,C++;return{x:ea(x/v),y:ea(B/v)}}function I(n,v){return n===v?1:ba(n)>=ba(v)?0>n?2:4:0>v?8:16}function O(n,v,x){x||
(x=ta);var B=v[x[0]]-n[x[0]];n=v[x[1]]-n[x[1]];return Math.sqrt(B*B+n*n)}function J(n,v,x){x||(x=ta);return 180*Math.atan2(v[x[1]]-n[x[1]],v[x[0]]-n[x[0]])/Math.PI}function N(){this.evEl=Aa;this.evWin=Ba;this.pressed=!1;D.apply(this,arguments)}function fa(){this.evEl=ua;this.evWin=va;D.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function ha(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;D.apply(this,arguments)}function S(){this.evTarget=
Ca;this.targetIds={};D.apply(this,arguments)}function R(n,v){var x=w(n.touches),B=this.targetIds;if(v&3&&1===x.length)return B[x[0].identifier]=!0,[x,x];n=w(n.changedTouches);var C=[],E=this.target;var G=x.filter(function(L){return u(L.target,E)});if(1===v)for(x=0;x<G.length;)B[G[x].identifier]=!0,x++;for(x=0;x<n.length;)B[n[x].identifier]&&C.push(n[x]),v&12&&delete B[n[x].identifier],x++;if(C.length)return[z(G.concat(C),"identifier",!0),C]}function ia(){D.apply(this,arguments);var n=m(this.handler,
this);this.touch=new S(this.manager,n);this.mouse=new N(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function U(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var v={x:n.clientX,y:n.clientY};this.lastTouches.push(v);var x=this.lastTouches;setTimeout(function(){var B=x.indexOf(v);-1<B&&x.splice(B,1)},2500)}}function ca(n,v){this.manager=n;this.set(v)}function ma(n){if(-1<n.indexOf("none"))return"none";var v=-1<n.indexOf("pan-x"),x=-1<n.indexOf("pan-y");return v&&x?"none":
v||x?v?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function P(n){this.options=X({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function ja(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function na(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function Y(n,v){return(v=v.manager)?v.get(n):n}function Q(){P.apply(this,arguments)}function da(){Q.apply(this,
arguments);this.pY=this.pX=null}function ka(){Q.apply(this,arguments)}function Z(){P.apply(this,arguments);this._input=this._timer=null}function V(){Q.apply(this,arguments)}function aa(){Q.apply(this,arguments)}function la(){P.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function W(n,v){v=v||{};var x=v.recognizers;v.recognizers=x===e?W.defaults.preset:x;return new ra(n,v)}function ra(n,v){this.options=X({},W.defaults,v||{});this.options.inputTarget=this.options.inputTarget||
n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ia(this,M);this.touchAction=new ca(this,this.options.touchAction);wa(this,!0);h(this.options.recognizers,function(x){var B=this.add(new x[0](x[1]));x[2]&&B.recognizeWith(x[2]);x[3]&&B.requireFailure(x[3])},this)}function wa(n,v){var x=n.element;if(x.style){var B;h(n.options.cssProps,function(C,E){B=A(x.style,E);v?(n.oldCssProps[B]=x.style[B],x.style[B]=C):x.style[B]=n.oldCssProps[B]||""});v||(n.oldCssProps=
{})}}function Ea(n,v){var x=c.createEvent("Event");x.initEvent(n,!0,!0);x.gesture=v;v.target.dispatchEvent(x)}var sa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),ea=Math.round,ba=Math.abs,qa=Date.now;var X="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var v=Object(n),x=1;x<arguments.length;x++){var B=arguments[x];if(B!==e&&null!==B)for(var C in B)B.hasOwnProperty(C)&&(v[C]=B[C])}return v}:Object.assign;
var xa=k(function(n,v,x){for(var B=Object.keys(v),C=0;C<B.length;){if(!x||x&&n[B[C]]===e)n[B[C]]=v[B[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,v){return xa(n,v,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var ta=["x","y"],oa=["clientX","clientY"];D.prototype={handler:function(){},init:function(){this.evEl&&p(this.element,this.evEl,this.domHandler);this.evTarget&&p(this.target,
this.evTarget,this.domHandler);this.evWin&&p(F(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&y(this.element,this.evEl,this.domHandler);this.evTarget&&y(this.target,this.evTarget,this.domHandler);this.evWin&&y(F(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},Aa="mousedown",Ba="mousemove mouseup";l(N,D,{handler:function(n){var v=Ja[n.type];v&1&&0===n.button&&(this.pressed=!0);v&2&&1!==n.which&&(v=4);this.pressed&&(v&4&&(this.pressed=
!1),this.callback(this.manager,v,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},ua="pointerdown",va="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(ua="MSPointerDown",va="MSPointerMove MSPointerUp MSPointerCancel");l(fa,D,{handler:function(n){var v=this.store,x=!1,B=n.type.toLowerCase().replace("ms","");B=Ka[B];var C=La[n.pointerType]||
n.pointerType,E="touch"==C,G=t(v,n.pointerId,"pointerId");B&1&&(0===n.button||E)?0>G&&(v.push(n),G=v.length-1):B&12&&(x=!0);0>G||(v[G]=n,this.callback(this.manager,B,{pointers:v,changedPointers:[n],pointerType:C,srcEvent:n}),x&&v.splice(G,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(ha,D,{handler:function(n){var v=Ma[n.type];1===v&&(this.started=!0);if(this.started){var x=w(n.touches);var B=w(n.changedTouches);v&12&&(x=z(x.concat(B),"identifier",!0));x=[x,B];v&12&&0===x[0].length-
x[1].length&&(this.started=!1);this.callback(this.manager,v,{pointers:x[0],changedPointers:x[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ca="touchstart touchmove touchend touchcancel";l(S,D,{handler:function(n){var v=Na[n.type],x=R.call(this,n,v);x&&this.callback(this.manager,v,{pointers:x[0],changedPointers:x[1],pointerType:"touch",srcEvent:n})}});l(ia,D,{handler:function(n,v,x){var B="mouse"==x.pointerType;if(!(B&&x.sourceCapabilities&&x.sourceCapabilities.firesTouchEvents)){if("touch"==
x.pointerType)v&1?(this.primaryTouch=x.changedPointers[0].identifier,U.call(this,x)):v&12&&U.call(this,x);else{if(B)a:{B=x.srcEvent.clientX;for(var C=x.srcEvent.clientY,E=0;E<this.lastTouches.length;E++){var G=this.lastTouches[E],L=Math.abs(C-G.y);if(25>=Math.abs(B-G.x)&&25>=L){B=!0;break a}}B=!1}if(B)return}this.callback(n,v,x)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var ya=A(Fa.style,"touchAction"),za=ya!==e,pa=function(){if(!za)return!1;var n={},v=b.CSS&&b.CSS.supports;
"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(x){n[x]=v?b.CSS.supports("touch-action",x):!0});return n}();ca.prototype={set:function(n){"compute"==n&&(n=this.compute());za&&this.manager.element.style&&pa[n]&&(this.manager.element.style[ya]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(v){q(v.options.enable,[v])&&(n=n.concat(v.getTouchAction()))});return ma(n.join(" "))},
preventDefaults:function(n){var v=n.srcEvent,x=n.offsetDirection;if(this.manager.session.prevented)v.preventDefault();else{var B=this.actions,C=-1<B.indexOf("none")&&!pa.none,E=-1<B.indexOf("pan-y")&&!pa["pan-y"];B=-1<B.indexOf("pan-x")&&!pa["pan-x"];if(C){var G=2>n.distance,L=250>n.deltaTime;if(1===n.pointers.length&&G&&L)return}if(!B||!E)if(C||E&&x&6||B&&x&24)return this.preventSrc(v)}},preventSrc:function(n){this.manager.session.prevented=!0;n.preventDefault()}};P.prototype={defaults:{},set:function(n){X(this.options,
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var v=this.simultaneous;n=Y(n,this);v[n.id]||(v[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=Y(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var v=this.requireFail;n=Y(n,this);-1===t(v,n)&&(v.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=Y(n,this);n=t(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function v(C){x.manager.emit(C,n)}var x=this,B=this.state;8>B&&v(x.options.event+ja(B));v(x.options.event);n.additionalEvent&&v(n.additionalEvent);8<=B&&v(x.options.event+ja(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=X({},n);q(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};l(Q,P,{defaults:{pointers:1},attrTest:function(n){var v=this.options.pointers;return 0===v||n.pointers.length===v},
process:function(n){var v=this.state,x=n.eventType,B=v&6;n=this.attrTest(n);return B&&(x&8||!n)?v|16:B||n?x&4?v|8:v&2?v|4:2:32}});l(da,Q,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,v=[];n&6&&v.push("pan-y");n&24&&v.push("pan-x");return v},directionTest:function(n){var v=this.options,x=!0,B=n.distance,C=n.direction,E=n.deltaX,G=n.deltaY;C&v.direction||(v.direction&6?(C=0===E?1:0>E?2:4,x=E!=this.pX,B=Math.abs(n.deltaX)):(C=0===
G?1:0>G?8:16,x=G!=this.pY,B=Math.abs(n.deltaY)));n.direction=C;return x&&B>v.threshold&&C&v.direction},attrTest:function(n){return Q.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var v=na(n.direction);v&&(n.additionalEvent=this.options.event+v);this._super.emit.call(this,n)}});l(ka,Q,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,
n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(Z,P,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var v=this.options,x=n.pointers.length===v.pointers,B=n.distance<v.threshold,C=n.deltaTime>v.time;this._input=n;if(!B||!x||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),
this._timer=f(function(){this.state=8;this.tryEmit()},v.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=qa(),this.manager.emit(this.options.event,this._input)))}});l(V,Q,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>
this.options.threshold||this.state&2)}});l(aa,Q,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return da.prototype.getTouchAction.call(this)},attrTest:function(n){var v=this.options.direction;if(v&30)var x=n.overallVelocity;else v&6?x=n.overallVelocityX:v&24&&(x=n.overallVelocityY);return this._super.attrTest.call(this,n)&&v&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&ba(x)>this.options.velocity&&
n.eventType&4},emit:function(n){var v=na(n.offsetDirection);v&&this.manager.emit(this.options.event+v,n);this.manager.emit(this.options.event,n)}});l(la,P,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var v=this.options,x=n.pointers.length===v.pointers,B=n.distance<v.threshold,C=n.deltaTime<v.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&C&&x){if(4!=
n.eventType)return this.failTimeout();x=this.pTime?n.timeStamp-this.pTime<v.interval:!0;B=!this.pCenter||O(this.pCenter,n.center)<v.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=B&&x?this.count+1:1;this._input=n;if(0===this.count%v.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},v.interval,this),2):8}return 32},failTimeout:function(){this._timer=f(function(){this.state=32},this.options.interval,this);return 32},reset:function(){clearTimeout(this._timer)},
...
ra.prototype={set:function(n){X(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var v=this.session;if(!v.stopped){this.touchAction.preventDefaults(n);var x=this.recognizers,B=v.curRecognizer;if(!B||B&&B.state&8)B=v.curRecognizer=null;for(var C=0;C<x.length;){var E=x[C];2===v.stopped||B&&E!=B&&!E.canRecognizeWith(B)?E.reset():
E.recognize(n);!B&&E.state&14&&(B=v.curRecognizer=E);C++}}},get:function(n){if(n instanceof P)return n;for(var v=this.recognizers,x=0;x<v.length;x++)if(v[x].options.event==n)return v[x];return null},add:function(n){if(g(n,"add",this))return this;var v=this.get(n.options.event);v&&this.remove(v);this.recognizers.push(n);n.manager=this;this.touchAction.update();return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var v=this.recognizers;n=t(v,n);-1!==n&&(v.splice(n,1),this.touchAction.update())}return this},
on:function(n,v){if(n!==e&&v!==e){var x=this.handlers;h(r(n),function(B){x[B]=x[B]||[];x[B].push(v)});return this}},off:function(n,v){if(n!==e){var x=this.handlers;h(r(n),function(B){v?x[B]&&x[B].splice(t(x[B],v),1):delete x[B]});return this}},emit:function(n,v){this.options.domEvents&&Ea(n,v);var x=this.handlers[n]&&this.handlers[n].slice();if(x&&x.length)for(v.type=n,v.preventDefault=function(){v.srcEvent.preventDefault()},n=0;n<x.length;)x[n](v),n++},destroy:function(){this.element&&wa(this,!1);
...
100;var q=e*h,p=e*k,y=0,u=0,r=0,t=0;toolBar&&(y=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,u=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,r=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,t=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(q>windowWidth){var w=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-t;l=-l-h*e*d.parameters.zoomArea.left/100+r}else w=-l-h*e*d.parameters.zoomArea.left/100+r,l=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-
t;p>windowHeight?(h=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u,d=-m-k*e*d.parameters.zoomArea.top/100+y):(h=-m-k*e*d.parameters.zoomArea.top/100+y,d=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u);g=Number.between(g,w,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
p.data[k+1]/255*u.g),p.data[k+2]!=u.b&&(y.data[k+2]=p.data[k+2]/255*u.b));h.putImageData(y,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(t){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(w){}})}}}}};
...
!0;m=new Date;r=(m-l)/20;var t=h-f,w=k-g;0==r?u=y=0:(y=t/r,u=w/r);void 0!=b&&b(y,u);window.clearInterval(q);q=-1}var f,g,h,k,l,m,q=-1,p=!1,y=0,u=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(r){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(r){}};
...
(function(b){function c(u,r){var t=(u&65535)+(r&65535);return(u>>16)+(r>>16)+(t>>16)<<16|t&65535}function d(u,r,t,w,z,A){u=c(c(r,u),c(w,A));return c(u<<z|u>>>32-z,t)}function e(u,r,t,w,z,A,F){return d(r&t|~r&w,u,r,z,A,F)}function f(u,r,t,w,z,A,F){return d(r&w|t&~w,u,r,z,A,F)}function g(u,r,t,w,z,A,F){return d(t^(r|~w),u,r,z,A,F)}function h(u,r){u[r>>5]|=128<<r%32;u[(r+64>>>9<<4)+14]=r;var t=1732584193,w=-271733879,z=-1732584194,A=271733878;for(r=0;r<u.length;r+=16){var F=t;var D=w;var M=z;var K=A;
t=e(t,w,z,A,u[r],7,-680876936);A=e(A,t,w,z,u[r+1],12,-389564586);z=e(z,A,t,w,u[r+2],17,606105819);w=e(w,z,A,t,u[r+3],22,-1044525330);t=e(t,w,z,A,u[r+4],7,-176418897);A=e(A,t,w,z,u[r+5],12,1200080426);z=e(z,A,t,w,u[r+6],17,-1473231341);w=e(w,z,A,t,u[r+7],22,-45705983);t=e(t,w,z,A,u[r+8],7,1770035416);A=e(A,t,w,z,u[r+9],12,-1958414417);z=e(z,A,t,w,u[r+10],17,-42063);w=e(w,z,A,t,u[r+11],22,-1990404162);t=e(t,w,z,A,u[r+12],7,1804603682);A=e(A,t,w,z,u[r+13],12,-40341101);z=e(z,A,t,w,u[r+14],17,-1502002290);
w=e(w,z,A,t,u[r+15],22,1236535329);t=f(t,w,z,A,u[r+1],5,-165796510);A=f(A,t,w,z,u[r+6],9,-1069501632);z=f(z,A,t,w,u[r+11],14,643717713);w=f(w,z,A,t,u[r],20,-373897302);t=f(t,w,z,A,u[r+5],5,-701558691);A=f(A,t,w,z,u[r+10],9,38016083);z=f(z,A,t,w,u[r+15],14,-660478335);w=f(w,z,A,t,u[r+4],20,-405537848);t=f(t,w,z,A,u[r+9],5,568446438);A=f(A,t,w,z,u[r+14],9,-1019803690);z=f(z,A,t,w,u[r+3],14,-187363961);w=f(w,z,A,t,u[r+8],20,1163531501);t=f(t,w,z,A,u[r+13],5,-1444681467);A=f(A,t,w,z,u[r+2],9,-51403784);
z=f(z,A,t,w,u[r+7],14,1735328473);w=f(w,z,A,t,u[r+12],20,-1926607734);t=d(w^z^A,t,w,u[r+5],4,-378558);A=d(t^w^z,A,t,u[r+8],11,-2022574463);z=d(A^t^w,z,A,u[r+11],16,1839030562);w=d(z^A^t,w,z,u[r+14],23,-35309556);t=d(w^z^A,t,w,u[r+1],4,-1530992060);A=d(t^w^z,A,t,u[r+4],11,1272893353);z=d(A^t^w,z,A,u[r+7],16,-155497632);w=d(z^A^t,w,z,u[r+10],23,-1094730640);t=d(w^z^A,t,w,u[r+13],4,681279174);A=d(t^w^z,A,t,u[r],11,-358537222);z=d(A^t^w,z,A,u[r+3],16,-722521979);w=d(z^A^t,w,z,u[r+6],23,76029189);t=d(w^
z^A,t,w,u[r+9],4,-640364487);A=d(t^w^z,A,t,u[r+12],11,-421815835);z=d(A^t^w,z,A,u[r+15],16,530742520);w=d(z^A^t,w,z,u[r+2],23,-995338651);t=g(t,w,z,A,u[r],6,-198630844);A=g(A,t,w,z,u[r+7],10,1126891415);z=g(z,A,t,w,u[r+14],15,-1416354905);w=g(w,z,A,t,u[r+5],21,-57434055);t=g(t,w,z,A,u[r+12],6,1700485571);A=g(A,t,w,z,u[r+3],10,-1894986606);z=g(z,A,t,w,u[r+10],15,-1051523);w=g(w,z,A,t,u[r+1],21,-2054922799);t=g(t,w,z,A,u[r+8],6,1873313359);A=g(A,t,w,z,u[r+15],10,-30611744);z=g(z,A,t,w,u[r+6],15,-1560198380);
w=g(w,z,A,t,u[r+13],21,1309151649);t=g(t,w,z,A,u[r+4],6,-145523070);A=g(A,t,w,z,u[r+11],10,-1120210379);z=g(z,A,t,w,u[r+2],15,718787259);w=g(w,z,A,t,u[r+9],21,-343485551);t=c(t,F);w=c(w,D);z=c(z,M);A=c(A,K)}return[t,w,z,A]}function k(u){var r,t="",w=32*u.length;for(r=0;r<w;r+=8)t+=String.fromCharCode(u[r>>5]>>>r%32&255);return t}function l(u){var r,t=[];t[(u.length>>2)-1]=void 0;for(r=0;r<t.length;r+=1)t[r]=0;var w=8*u.length;for(r=0;r<w;r+=8)t[r>>5]|=(u.charCodeAt(r/8)&255)<<r%32;return t}function m(u){return k(h(l(u),
8*u.length))}function q(u,r){var t=l(u),w=[],z=[];w[15]=z[15]=void 0;16<t.length&&(t=h(t,8*u.length));for(u=0;16>u;u+=1)w[u]=t[u]^909522486,z[u]=t[u]^1549556828;r=h(w.concat(l(r)),512+8*r.length);return k(h(z.concat(r),640))}function p(u){var r="",t;for(t=0;t<u.length;t+=1){var w=u.charCodeAt(t);r+="0123456789abcdef".charAt(w>>>4&15)+"0123456789abcdef".charAt(w&15)}return r}function y(u,r,t){r?t?u=q(unescape(encodeURIComponent(r)),unescape(encodeURIComponent(u))):(u=q(unescape(encodeURIComponent(r)),
...
h),5);case 5:u=t.yieldResult,y&&y.forEach(function(w){return w.resolve(u)});case 3:t.enterFinallyBlock();delete e[m];delete f[m];t.leaveFinallyBlock(0);break;case 2:r=t.enterCatchBlock(),y&&y.forEach(function(w){return w.reject(r)}),t.jumpTo(3)}})},c)})}}
...
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(p,y){var u=c();try{var r=y&&"object"===typeof y?Object.assign({},y):y;if(r&&"object"===typeof r){r.page=Number(p+1);var t=u[p];t&&t.positions&&r.positions?r.positions=t.positions.concat(r.positions):t&&t.positions&&(r.positions=t.positions);null!=l?r.realPage=Number(l):t&&t.realPage&&(r.realPage=t.realPage);t&&Object.keys(t).forEach(function(w){"page"===w||"realPage"===w||"positions"===
w||w in r||(r[w]=t[w])})}u[p]=r;return!0}catch(w){return console.error("writeToTarget error",w),!1}}function e(p,y,u){if(!p||0===p.length)return null;for(var r=p[0].left,t=p[0].top,w=p[0].right,z=p[0].bottom,A="",F=0;F<p.length;F++){var D=p[F];r=Math.min(r,D.left);t=Math.min(t,D.top);w=Math.max(w,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=r/y;t/=u;w/=y;u=z/u;u=[F,u,w,u,w,t,F,t];z=[];for(F=0;F<p.length;F++)z.push(p[F].width/y);if(!A||0===A.trim().length)return null;p=u.concat(z);return{w:A,p:p}}
function f(p){b._pageReaderExtracted||(b._pageReaderExtracted={});p=Array.isArray(p)?p:[p];for(var y=0,u=0;u<p.length;u++){var r=p[u];if(r&&!(1>r)&&!b._pageReaderExtracted[r])if(b._pageReaderExtracted[r]=!0,window._getPage&&"function"===typeof window._getPage)try{var t=window._getPage(r-1);if(t){var w=null;if(t.items&&Array.isArray(t.items)){w=t.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<w.length;D++){var M=w[D];if(M&&"text"===M.type&&
...
r=function(){var w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.setCatchFinallyBlocks(2,3),w=String.format(bookConfig.searchPositionJS,y),1<y&&(w=w.replace("[1]","["+y+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,w.match(z)||w.match(A)?D.yield(getArticleImage(fixURLValue(w)),5):D.return(!1);case 5:return(w=D.yieldResult)?D.yield(h(p,w,y),6):D.return(!1);case 6:return b._positionScriptLoaded[y]=!0,D.return(!0);
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[y];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[y]=r;return t.return(r)})}function h(p,y,u){var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){r=function(){var w,z,A,F,D,M,K;return $jscomp.asyncExecutePromiseGeneratorProgram(function(H){switch(H.nextAddress){case 1:k=p;l=u;if(w="undefined"!==
...
y)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q});"undefined"!==typeof b&&null==b._positionScriptLoadPromises&&(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(p){var y,u,r,t,w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||
(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),y=Array.isArray(p)?p:[p],u=[],r=!1,t=0;case 2:if(!(t<y.length)){D.jumpTo(4);break}w=y[t];if(!w||1>w){D.jumpTo(3);break}z={pageIndex:w,hasText:!1,positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(g(w),7);case 7:b._pageReaderExtracted[w]||f(w);(A=c()[w-1])&&A.page===w&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,
r=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+w+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:u.push(z);case 3:t++;D.jumpTo(2);break;case 4:return D.return({hasText:r,pageResults:u})}})};b.hasPageText=function(p){b.pageTextPositions||(b.pageTextPositions=[]);var y=!Array.isArray(p),u=[],r=!1;p=$jscomp.makeIterator(y?[p]:p);for(var t=p.next();!t.done;t=p.next())if(t=t.value,!t||1>t)y||u.push({pageIndex:t,hasText:!1,
positionCount:0});else{var w={pageIndex:t,hasText:!1,positionCount:0},z=t-1;(z=c()[z])&&z.page===t&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(w.hasText=!0,w.positionCount=z.positions.length,r=!0);if(y)return w.hasText;u.push(w)}return{hasText:r,pageResults:u}};b.loadPagePositionScript=g;b.loadAndFixPositionScript=h;b.clearPageTextPositions=function(){b.pageTextPositions&&(b.pageTextPositions.length=0);b._positionScriptLoaded&&(b._positionScriptLoaded={});b._positionScriptLoadPromises&&
...
300);tmpBookConfig.maxHeightToSmallMode=getConfigValue("maxHeightToSmallMode",300);tmpBookConfig.backgroundScene=getConfigValue("backgroundScene","None");tmpBookConfig.bgSoundVol=getConfigValue("bgSoundVol",50);tmpBookConfig.bgSoundVol=Number.between(tmpBookConfig.bgSoundVol,0,100);tmpBookConfig.enablePageBack=getConfigValue("enablePageBack",!1);if(isPhone()||isPad())tmpBookConfig.enablePageBack=tmpBookConfig.isMobilePageBackButtonVisible;tmpBookConfig.userListPath=getConfigValue("userListPath","files/extfiles/users.js");
tmpBookConfig.excludeFrontPages=getConfigValue("excludeFrontPages","");tmpBookConfig.isFlipPdf=getConfigValue("isFlipPdf",!1);tmpBookConfig.SingleModeBanFlipToLastPage=getConfigValue("SingleModeBanFlipToLastPage",!1);tmpBookConfig.isSingleBookFullWindowOnMobile=getConfigValue("isSingleBookFullWindowOnMobile",!1);tmpBookConfig.showGotoButtonsAtFirst=getConfigValue("showGotoButtonsAtFirst",!1);0==tmpBookConfig.isFlipPdf&&void 0!=global.isFlipPdf&&(tmpBookConfig.isFlipPdf=isFlipPdf);tmpBookConfig.FlipSound=
getConfigValue("FlipSound",!0);global.flipSoundIsPlaying=tmpBookConfig.FlipSound;tmpBookConfig.CurlingPageCorner=getConfigValue("CurlingPageCorner",!0);tmpBookConfig.BanFlipFromDirection=getConfigValue("BanFlipFromDirection",!1);tmpBookConfig.iconFontColor=getConfigValue("iconFontColor","#ffffff");tmpBookConfig.updateURLForPage=getConfigValue("updateURLForPage",!0);tmpBookConfig.borderColor=getConfigValue("borderColor","#572f0d");tmpBookConfig.outerCoverBorder=getConfigValue("outerCoverBorder",!1);
tmpBookConfig.hardCoverBorderWidth=getConfigValue("hardCoverBorderWidth",0);tmpBookConfig.cornerRound=getConfigValue("cornerRound",0);tmpBookConfig.hardCoverBorderWidth=tmpBookConfig.HardPageEnable?Number.between(0,16,tmpBookConfig.hardCoverBorderWidth):0;tmpBookConfig.cornerRound=tmpBookConfig.HardPageEnable?Number.between(0,tmpBookConfig.hardCoverBorderWidth,tmpBookConfig.cornerRound):0;tmpBookConfig.coverTexture=getConfigValue("coverTexture","none");tmpBookConfig.passwardPrompt=getConfigValue("passwardPrompt",
"");tmpBookConfig.SlideshowAutoPlay=getConfigValue("SlideshowAutoPlay",!1);tmpBookConfig.SlideshowPlayInterval=getConfigValue("SlideshowPlayInterval",5);tmpBookConfig.productName=getConfigValue("productName","Flip HTML5");tmpBookConfig.homePage=getConfigValue("homePage","http://www.fliphtml5.com");global.productName=tmpBookConfig.productName||"Flip HTML5";global.homePage=tmpBookConfig.homePage||"http://www.fliphtml5.com";tmpBookConfig.backgroundPosition=getConfigValue("backgroundPosition","Stretch");
tmpBookConfig.restorePageVisible=getConfigValue("restorePageVisible",!1);tmpBookConfig.restorePageDuration=getConfigValue("restorePageDuration",86400);tmpBookConfig.toobarClear=getConfigValue("toobarClear",!1);tmpBookConfig.bottomToolBarAlpha=getConfigValue("bottomToolBarAlpha",1);tmpBookConfig.topToolBarAlpha=getConfigValue("topToolBarAlpha",1);tmpBookConfig.ToolBarAlpha=getConfigValue("ToolBarAlpha",1);tmpBookConfig.phoneSearchBarAlpha=getConfigValue("phoneSearchBarAlpha",.8);!isPhone()&&!isPad()||
["slide","docview","card","inverteffect"].includes(tmpBookConfig.FlipStyle.toLowerCase())||(tmpBookConfig.FlipStyle="flip");isBelowIE9()&&(tmpBookConfig.FlipStyle="slide");if(isPhone()||isPad()||"slide"==tmpBookConfig.FlipStyle.toLowerCase()&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase())tmpBookConfig.flipshortcutbutton=!1;if("slide"==tmpBookConfig.FlipStyle&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase()||isPhone()||isPad())tmpBookConfig.flipshortcutbutton=!1;void 0===tmpBookConfig.isFirstLastShortcutVisible&&
(tmpBookConfig.isFirstLastShortcutVisible=!!tmpBookConfig.flipshortcutbutton);if(global.videoList&&1<=global.videoList.length)for(e=0;e<videoList.length;e++)videoList[e].id||(videoList[e].id=""),videoList[e].description||(videoList[e].description=""),videoList[e].thumbnail||(videoList[e].thumbnail=""),videoList[e].title||(videoList[e].title=""),videoList[e].type||(videoList[e].type="");try{window.localStorage||(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=
...
"fit");try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(e=0;e<window.ignoreModuleArray.bookConfig.length;e++)f=window.ignoreModuleArray.bookConfig[e],void 0!=tmpBookConfig[f]&&(tmpBookConfig[f]=!1)}catch(l){}checkFlipStyleConfig();return"issuu"==tmpBookConfig.FlipStyle?k.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"),7):k.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),7);case 7:checkPageEditorConfig(),recordError(),g=Module._getVerifyString(),
h=UTF8ToString(g),Module._free(g),eval(h),k.jumpToEnd()}})};function recordError(){try{var b=window.setInterval(function(){window.onBookError&&(tmpBookConfig.largePageWidth&&tmpBookConfig.largePageHeight&&tmpBookConfig.totalPageCount||BookEvent.trigger("errorLog",[JSON.stringify({largePageWidth:tmpBookConfig.largePageWidth,largePageHeight:tmpBookConfig.largePageHeight,totalPageCount:tmpBookConfig.totalPageCount,type:"BookConfigError"})]),window.clearInterval(b))},500)}catch(c){}}
function setBookVerticalMargin(b){b=void 0===b?{}:b;try{var c=global.staticAd&&global.staticAd.haveAd&&"Chinese"!=UserGroups&&global.staticAd.adPosition?!0:!1,d=global.staticAd.height||90,e=tmpBookConfig.ORIGIN_TOP_MARGIN,f,g,h,k=!(null==(f=global.bmtConfig)?0:f.onSideEdge)&&0<(null==(g=global.bmtConfig)?void 0:null==(h=g.tabs)?void 0:h.length),l,m=null!=(l=b.bookmarkHeight)?l:70;k&&e<m&&(e=m);if(c&&2==global.staticAd.adPosition)if(e<d+20)e+=d+20;else{var q=BookInfo.top()-templateArea.getTopHeight();
e=Math.max(e,q)}tmpBookConfig.topMargin=e;var p=tmpBookConfig.ORIGIN_BOTTOM_MARGIN;c&&1==global.staticAd.adPosition&&p<d+20&&(p+=d+20);tmpBookConfig.bottomMargin=p;b.disableResize||"function"!=typeof global.onStageResize||onStageResize()}catch(y){console.log("setBookVerticalMargin error",y)}}
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026040101",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
this.initLogo(),bookConfig.ToolBarVisible&&this.initFullscreenButton(),this.initZoomButton(),this.initFlipShotButton(),this.initSlider(),this.initPageNumber())},initFullscreenButton:function(){var b=this;this.button=$("<div><img title='"+getLanguage("viewFullScreen","\u93cc\u30e7\u6e45\u934f\u3125\u7746")+"' style='pointer-events: none;' src='"+uiBaseURL+"NeatFullscreen.svg'/></div>");this.button.css({position:"absolute",bottom:"0px",left:"auto",top:"auto",cursor:"pointer","z-index":"100",width:"42px",
height:"42px",right:"9px"});this.button.find("img").css({position:"absolute",left:"12px",top:"12px",width:"18px",height:"18px"});this.button.on(_event._down,function(c){return c.stopPropagation()});this.button.on("click",function(){b.isNeat()&&(isPhone()||isPad()?(window.parent.postMessage({command:"full"},"*"),b.full=!0):readAsFullscreen())});tmpContainer.append(this.button)},initZoomButton:function(){this.zoomButton=new NeatZoomButton;this.zoomButton.addTo(tmpContainer)},initLogo:function(){if(this.isShowLogo&&
...
"logo"]);var b=getAppLogoLinkURL();window.open(b,bookConfig.appLogoOpenWindow);return!1});tmpContainer.append(this.logo)}},hideLogo:function(){this.logo&&(this.logo.hide(),this.isShowLogo=!1)},exitFullscreen:function(){this.full=!1},initFlipShotButton:function(){this.pagePrevButton=$("<div class='btn' style='display:none;'><div class='svg-box'></div><img class='unSelect' src='"+uiBaseURL+"previousPage.svg' style='width:40px;height:40px;margin:0px;pointer-events: none;'/></div>");this.pageNextButton=
$("<div class='btn' style='display:none;'><div class='svg-box'></div><img class='unSelect' src='"+uiBaseURL+"nextPage.svg' style='width:40px;height:40px;margin:0px;pointer-events: none;'/></div>");this.pagePrevButton.css({position:"absolute",width:"40px",height:"40px",top:"50%",left:"0","z-index":"11",transform:"translate(0%,-50%)",cursor:"pointer"});this.pageNextButton.css({position:"absolute",width:"40px",height:"40px",top:"50%",right:"0","z-index":"11",transform:"translate(0%,-50%)",cursor:"pointer"});
...
this.elements.changeLanguage();this.title&&this.title.find("span").html(FormInfo.getFormTitle(this.formType))},setA11y:function(){this.close&&(this.close.attr("tabindex",0),this.close.attr("role","button"),this.close.off("keydown.a11y").on("keydown.a11y",function(b){"Enter"!==b.key&&" "!==b.key||$(this).trigger("click")}));this.stage&&this.stage.find(".btn, .button, button").each(function(){$(this).attr("tabindex",0);$(this).attr("role","button");$(this).off("keydown.a11y").on("keydown.a11y",function(b){"Enter"!==
b.key&&" "!==b.key||$(this).trigger("click")})})},setA11yAndFocus:function(b){void 0===b&&(b=!0);this.setA11y();b&&(this.stage.attr("tabindex",-1),$(tmpContainer).attr("tabindex",-1),this.stage.focus())}}),FadeOutFadeForm=Class({create:function(b){this._super(b);this.closeUrl=window.form_icons&&form_icons.close?"data:image/png;base64,"+form_icons.close:uiBaseURL+"close.png";this.stage=$("<div class='"+FormInfo.getFormCssClassName(this.formType,this.isPhone)+"'></div>");this.title=$("<p class='form_title'></p>");
FormInfo.getFormTitle(this.formType)&&this.title.append($("<span>"+FormInfo.getFormTitle(this.formType)+"</span>"));FormInfo.getFormFavicon(this.formType)&&(this.favicon=$("<img alt='favicon' width='auto' height='auto' class='favicon' src='"+FormInfo.getFormFavicon(this.formType)+"'/>"));this.close=$("<img alt='close' width='auto' height='auto' class='close' src='"+this.closeUrl+"'/>");this.rightToLeft&&this.stage.addClass("rightToLeft");this.initHtml();this.initEvent();this.onCreate()},onCreate:function(){var b=
...
function getArticleEditor(){function b(t){if(window.isExecuteGetInverseEditor)var w=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(w),t()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),t(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,t)},t,"")}function c(t,w,z,A,F){var D=new XMLHttpRequest;D.responseType=
void 0===A?"json":A;D.open("GET",t);D.send();D.onreadystatechange=function(){4===D.readyState&&(200===D.status||304===D.status?w&&w(D):"bookinfo"===F&&w?w():z&&z(w))};D.error=function(){z&&z(w)}}function d(t,w){r&&(clearTimeout(r),r=null);if(window.Module.isReady){var z=allocateUTF8(t.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);w();window.runArticleEditor&&delete window.runArticleEditor}else r=setTimeout(function(){d(t,w)},100)}function e(t){(window.articleListConfig=
t)?g(t):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&q(function(t){window.articleConfig=t.response})}function g(t){for(var w=[],z=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],F=0;F<z;F++){for(var D=A&&A.length&&A[F]?A[F].index:F,M=[],K=0;K<t.length;K++)(t[K].articles?t[K].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
...
x:I.rect.x,y:I.rect.y,width:I.rect.width,height:I.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:I.rect.pageWidth,pageHeight:I.rect.pageHeight}:""}I&&H.articleTextList&&H.articleTextList.length&&(H=k(H),J=h(H,I),M.push(J))}});w.push(M)}console.log("currentPageEditor",JSON.parse(JSON.stringify(w)));window.inverseEditor=w}function h(t,w){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
...
y=0;y<canvasData[b].resources.length;y++)if(1!=canvasData[b].resources[y].type)p++,p>=canvasData[b].resources.length&&k();else{var u=new Image;u.src=getResource(b,y);globalImages[b][y]=u;u.onload=function(){p++;p>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(y){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(u){bookConfig.largePageWidth/bookConfig.largePageHeight>u[0].naturalWidth/u[0].naturalHeight?u.css({width:"auto",height:"100%"}):u.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)q=c[m],q=q.removeStartFrom("?"),p=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),p.attr("src",q),k.append(p),p[0].onload=function(u){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},p[0].onerror=function(u){h++;h==c.length&&
...
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),q.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),m=$("<img src='"+l+"'/>"),m[0].onload=function(){e&&e(l,c,this,b)},q.return();loadJavascript(c,function(p){var y=dataBase64Str(b,d,p);$("<img src='"+y+"'/>")[0].onload=function(){e&&e(y,c,this,b)}},function(){});
return q.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(!window.printLoadStack)return q.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;m=new PdfLoadingTask(b,d,k,l,function(p){var y=p.toDataURL("image/png"),u=$("<img src='"+y+"'/>");u[0].onload=function(){e&&e(y,y,u,b)}}.bind(h));window.printLoadStack.push(m);return q.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),p.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),p.return();q=h;loadJavascript(k,function(y){var u=dataBase64Str(b,c,y);q.$image=$("<img src='"+
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,m,q,p){p=void 0===p?!1:p;var y=h[m],u=Math.abs(l-k);if(!(0>=u)){q=q?y.width:y.height;l=0;if(u>=q)for(l=Math.floor((u+c.spacing)/(q+c.spacing));0<l&&!(l*q+(l-1)*c.spacing<=u);)l--;if(!(0>=l)){u=1<l?(u-l*q)/(l-1):0;for(var r=0;r<l;r++){var t=p?k-r*(q+u):k+r*(q+u),w=void 0,z=void 0;switch(m){case "top":w=t+(y.width-c.width)/2;z=(y.height-c.height)/2+f;break;case "right":w=b.canvas.width-(c.width+y.width)/2-f;z=t+(y.height-c.height)/
2;break;case "bottom":w=t+(y.width-c.width)/2;z=b.canvas.height-(c.height+y.height)/2-f;break;case "left":w=(y.width-c.width)/2+f,z=t+(y.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,w,z,g[m],c,p)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
25,"Sine");q++}.interval(this,l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,y){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,t=$.easing["easeInOut"+y],w=$.easing["easeOut"+y];y=w(null,q,g,b.toPoint.x-g,p);w=w(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(y=t(null,q,g,b.toPoint.x-g,p),w=bookConfig.FlipDirection?f*Math.sqrt(r*r-y*y):r-f*Math.sqrt(u*u-y*y));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:y,y:w}):(this.flipToPoint(b,c,d,b.fromPoint,
...
l,m,q,p;h=null==c?void 0:null==(k=c.pageArray[b])?void 0:null==(l=k.pageArray)?void 0:null==(m=l[b])?void 0:null==(q=m.pageAttachments)?void 0:null==(p=q.pageAnnotation)?void 0:p.pageAnnotation}return h}}}),FlipHistory=Class({create:function(){this.array=[];this.currentIndex=0},backward:function(){var b=this.currentIndex-1;void 0!=this.array[b]&&(this.currentIndex=b,gotoPageFun(this.array[b].index,!0,"history"),window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons())},forward:function(){var b=
this.currentIndex+1;void 0!=this.array[b]&&(this.currentIndex=b,gotoPageFun(this.array[b].index,!0,"history"),window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons())},addFromCurrentIndex:function(b){this.array=this.array.slice(0,this.currentIndex+1);this.array.push({index:b});this.currentIndex=this.array.length-1;window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons()},push:function(b){this.array.push({index:b})},canBackward:function(){return void 0!=this.array[this.currentIndex-
1]},canForward:function(){return void 0!=this.array[this.currentIndex+1]}}),flipHistory=new FlipHistory,IssuuPage=Class({create:function(b,c,d,e){this._super(b,c,d,e);this.renderPage();this.addFlipShadow()},remove:function(){this.sideImage&&this.sideImage.remove();this.side.remove();this.sideImage=this.side=void 0;this.pageBackground&&this.pageBackground.destroy();this.render&&(this.render.taskPool.stop(),this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0));
this.hasReader&&this.destroySlider()},destroy:function(){this.pageBackground&&this.pageBackground.destroy();this.sideImage=this.side=void 0;this.hasReader&&this.destroySlider()},hasReader:function(){return window.readerConfig&&0<window.readerConfig.pages.length&&window.readerConfig.pages.length>=this.pageIndex&&(this.hasReaderItems()||window.inverseEditor&&window.inverseEditor.length&&window.inverseEditor[this.pageIndex-1]&&window.inverseEditor[this.pageIndex-1].length)?!0:!1},hasReaderItems:function(){var b=
...
c,d,e,f,g,h,k,l){var m=this,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;q=c;bookConfig.useTheAliCloudChart&&!bookConfig.isEncryptionBook&&(q=q.removeStartFrom("?"));m.imageURL=q;m.$image=$("<img src='"+m.imageURL+"' style='z-index:0;'/>");bookConfig.EnableRecognizeQRcodePressOnMobile&&m.$image.css({"-webkit-touch-callout":"default"});m.$image[0].onload=function(){this.callback&&
...
transformCSS({tran:l?l:{x:0,y:0},scale:{x:q,y:p},origin:g});if(m.isCoverPage(u.pageIndex))if(u.tran=l?l:{x:0,y:0},u.scale={x:q,y:p},u.rotateY){u.$page[0].style.removeProperty("transform-origin");var t;r=transformCSS({scale:{x:q,y:p},perspective:6E3,rotateY:null!=(t=u.rotateY)?t:0})}else{var w;r=transformCSS({origin:g,scale:{x:q,y:p},perspective:6E3,rotateY:null!=(w=u.rotateY)?w:0})}u.setCSSByStyle(r);r=h?transformCSS({scale:{x:k.x/q,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});u.page.pageFlipShadow&&
