...
formClose:'<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" t="1592905340100" width="100%" height="100%" viewBox="0 0 1024 1024" version="1.1" p-id="4217" width="200" height="200"><defs><style type="text/css"/></defs><path fill='+(tmpBookConfig.formFontColor?tmpBookConfig.formFontColor:tmpBookConfig.iconColor)+' d="M369.728 512l384.768-384.704a48.64 48.64 0 0 0 0.896-68.8 48.64 48.64 0 0 0-68.736 0.96L269.44 476.736a48.704 48.704 0 0 0-11.136 17.344c-1.024 2.304-1.024 4.736-1.472 7.04-0.896 3.648-2.048 7.168-2.048 10.88 0 3.712 1.152 7.232 1.984 10.88 0.512 2.368 0.512 4.8 1.472 7.04a48.704 48.704 0 0 0 11.136 17.344l417.216 417.28a48.576 48.576 0 0 0 68.736 0.96 48.576 48.576 0 0 0-0.896-68.736L369.728 512z" p-id="3489"/></svg>',
...
"Forward Button")+" ><div class='svg-box'></div><img src='' style='max-width:20px;max-height:20px;margin:0px;pointer-events: none;'/></div>");this.goButton=$("<div class='goBtn'><div class='svg-box'></div><img src='' style='max-width:20px;max-height:20px;margin:0px;pointer-events: none;'/></div>");this.createFlipButtons();this.setSrc(this.backwardButton,"backward",bookConfig.BackwardButtonIcon);this.setSrc(this.firstButton,"firstPage",bookConfig.FirstButtonIcon);this.setSrc(this.prevButton,"previousPage",
bookConfig.PreviousButtonIcon);this.setSrc(this.nextButton,"nextPage",bookConfig.NextButtonIcon);this.setSrc(this.lastButton,"lastPage",bookConfig.LastButtonIcon);this.setSrc(this.forwardButton,"forward",bookConfig.ForwardButtonIcon);this.setSrc(this.goButton,"goPage");this.inputButton=$("<div class='inputButton' style='width:190px;'>\n        <label>\n          <input aria-labelledby='currentPageIndex' id='currentPageIndexTextField' enterkeyhint=\"go\" type='text'/>\n        </label>\n      </div>");
...
createFlipButtons:function(){bookConfig.FlipDirection?(this.pagePrevButton=$("<div class='btn' style='display:none;'><div class='svg-box'></div><img src='"+phoneBaseURL+"previousPage2.png' style='width:100%;height:100%;margin:0px;pointer-events: none;'/></div>"),this.pageNextButton=$("<div class='btn' style='display:none;'><div class='svg-box'></div><img src='"+phoneBaseURL+"nextPage2.png' style='width:100%;height:100%;margin:0px;pointer-events: none;'/></div>")):(this.pagePrevButton=$("<div class='btn' style='display:none;'><div class='svg-box'></div><img src='"+
phoneBaseURL+"previousPage.png' style='width:100%;height:100%;margin:0px;pointer-events: none;'/></div>"),this.pageNextButton=$("<div class='btn' style='display:none;'><div class='svg-box'></div><img src='"+phoneBaseURL+"nextPage.png' style='width:100%;height:100%;margin:0px;pointer-events: none;'/></div>"))}});
