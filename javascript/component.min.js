...
this.initHtml();this.initEvent();this.fillContent(this.currentPageIndex)},initDefaultDom:function(){this.thumbnail=$("<div class='thumbnail'></div>");this.page=$("<div class='page'></div>");this.image=$("<img/>");this.noThumbBg=$("<div style='display:none;margin: 0 auto;background:"+bookConfig.pageBackgroundColor+";width:100px;height:130px;'></div>");this.options.leftButton?(this.leftBtn=this.options.leftButton,this.rightBtn=this.options.rightButton):(this.leftBtn=$("<img class='leftBtn btn button_hover' src='"+
this.leftButtonUrl+"'/>"),this.rightBtn=$("<img class='rightBtn btn button_hover' src='"+this.rightButtonUrl+"'/>"));this.thumbnail.append(this.noThumbBg).append(this.image);this.thumbnail.append(this.page)},resetBtnSrc:function(){this.options.leftButton?(this.leftBtn=this.options.leftButton,this.rightBtn=this.options.rightButton):(this.leftBtn.attr("src",this.leftButtonUrl),this.rightBtn.attr("src",this.rightButtonUrl))},initEvent:function(){this.leftBtn.bind(_event._click,function(){this.fillContent(this.currentPageIndex-
1)}.bind(this));this.rightBtn.bind(_event._click,function(){this.fillContent(this.currentPageIndex+1)}.bind(this))},fillContent:function(a){if(!(1>a||a>bookConfig.totalPageCount)){1==a?this.leftBtn.css({opacity:"0.4",cursor:"auto"}):this.leftBtn.css({opacity:"1",cursor:"pointer"});a==bookConfig.totalPageCount?this.rightBtn.css({opacity:"0.4",cursor:"auto"}):this.rightBtn.css({opacity:"1",cursor:"pointer"});this.currentPageIndex=a;var b=function(c,d){c.match(/^none/)?(this.noThumbBg.css({display:"block"}),
this.image.css({display:"none"})):(this.image.attr("src",c),this.noThumbBg.css({display:"none"}),this.image.css({display:"inline-block",width:this.imageWidth+"px",height:"130px",objectFit:"contain"}))}.bind(this);pageResourceLoad(a,"thumb",b);this.fillPage(a);this.callback&&this.callback(a)}},fillPage:function(a){this.page.html(a+"/"+bookConfig.totalPageCount)},getPageIndex:function(){return this.currentPageIndex},updateVisibility:function(){this.showNavigation&&1<bookConfig.totalPageCount?(this.stage.find(this.leftBtn).length||
this.stage.append(this.leftBtn),this.stage.find(this.rightBtn).length||this.stage.append(this.rightBtn),this.leftBtn.show(),this.rightBtn.show()):(this.leftBtn.hide(),this.rightBtn.hide());this.showPageInfo?(this.thumbnail.find(this.page).length||this.thumbnail.append(this.page),this.page.show()):this.page.hide()},setNavigationVisible:function(a){this.showNavigation=a;this.updateVisibility()},setPageInfoVisible:function(a){this.showPageInfo=a;this.updateVisibility()},setControlsVisible:function(a){this.showPageInfo=
this.showNavigation=a;this.updateVisibility()}}),PictureListForm=Class({initHtml:function(){this.stage=$("<div class='"+(this.options&&this.options.className?this.options.className:"pictureList_win10")+"'></div>");this.stage.append(this.thumbnail);this.updateVisibility()},getDom:function(){return this.stage}}).extend(PictureListFrame),AnalysisPrint=Class({create:function(a,b){b=void 0===b?{}:b;this.printArea=$("<div class='print-area' style='width:100%;height:100%;position:absolute;left:0;top:0;'></div>");
this.button=a;this.parent=b.parent||tmpContainer;this.options=b;this.initPrintEvent()},getImageSizeForMM:function(a,b){return a/210>=b/297?{width:210,height:Math.floor(210*b/a)}:{width:Math.floor(297*a/b),height:297}},getImageSizeForInches:function(a,b){return a/7.18>=b/10.61?{width:7.18,height:Number.fixed(7.18*b/a,2)}:{width:Number.fixed(10.61*a/b,2),height:10.61}},getImageSizeForIE:function(a,b){return a/8>=b/11.3?{width:8,height:Number.fixed(8*b/a,2)}:{width:Number.fixed(11.3*a/b,2),height:11.3}},
printPages:function(a){var b=this,c,d,e,g,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(!a||!a.length||!parseBool(bookConfig.PrintButtonVisible))return k.return();b.initLoadPrint();c=0;b.printArea.empty();b.printArray=[];d=function(l,m,p,n){var q=this,t,r,x,u,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){switch(w.nextAddress){case 1:return t=$("<div style='position:relative;width:100%;height:100%;'></div>"),r=$(p),l&&-1<l.indexOf("none")&&!l.startsWith("data:image")&&
m&&0>m.indexOf("none")&&(r=$(m)),void 0===n&&(n=p),w.setCatchFinallyBlocks(2),w.yield(q.createCompositeImage(r,l),4);case 4:(x=w.yieldResult)&&(r=$(x));w.leaveTryBlock(3);break;case 2:u=w.enterCatchBlock(),console.error("Canvas\u935a\u581f\u579a\u6fb6\u8fab\u89e6:",u);case 3:t.append(r);$(r).parent().css({"text-align":"center",width:"100%",height:"100%"});r.css({"text-align":"center","max-width":"100%","max-height":"100%"});"stretch"===bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%"}):
"fill"===bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%","object-fit":"cover"}):$(r).parent().css({display:"flex","justify-content":"center","align-items":"center"});q.printArray[n]=t;c++;if(c==a.length){for(v=0;v<q.printArray.length;v++)q.printArray[v]&&q.printArea.append(q.printArray[v]);q.printArea.printArea({onReady:q.hidePrintLoading.bind(q)})}w.jumpToEnd()}})};e=BookInfo.getBook().pageWidth;g=BookInfo.getBook().pageHeight;f={};for(h=0;h<a.length;f={$jscomp$loop$prop$page$4:f.$jscomp$loop$prop$page$4},
h++)f.$jscomp$loop$prop$page$4=a[h],getPageDir(f.$jscomp$loop$prop$page$4,"normal").then(function(l){return function(m){var p=e,n=g;if(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<m.indexOf("zip"))window.printLoadStack||b.initPrintStack(a),p=2*e,n=2*g;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(l.$jscomp$loop$prop$page$4).then(function(q){pageResourceLoad(l.$jscomp$loop$prop$page$4,q,d.bind(b),p,n)}):pageResourceLoad(l.$jscomp$loop$prop$page$4,"normal",d.bind(b),p,n)}}(f));
k.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d"),h=new Image;h.crossOrigin="anonymous";h.onload=function(){var k,l,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return n.setCatchFinallyBlocks(2),g.width=h.naturalWidth,g.height=h.naturalHeight,f.drawImage(h,0,0),n.yield(c.createWatermarkWithPageWatermark(h.naturalWidth,h.naturalHeight),4);if(2!=n.nextAddress)return(k=
n.yieldResult)?f.drawImage(k,0,0):console.log("watermarkCanvas error"),l=g.toDataURL("image/png"),m=document.createElement("img"),m.src=l,m.style.cssText=a[0].style.cssText,d(m),n.leaveTryBlock(0);p=n.enterCatchBlock();console.error("canvas error:",p);d(null);n.jumpToEnd()})};h.onerror=function(){console.log("img.onerror:",b);d(null)};h.src=b}catch(k){console.log("createCompositeImage error:",k),d(null)}})},createWatermarkWithPageWatermark:function(a,b){return new Promise(function(c){if(parseBool(bookConfig.PrintButtonVisible)&&
bookConfig.printWatermark)try{var d=document.createElement("canvas");d.width=a;d.height=b;var e=new WatermarkCore(d),g=BookInfo.getBook().pageWidth,f=BookInfo.getBook().pageHeight,h=Math.min(a/g,b/f),k={position:bookConfig.watermarkPosition,width:(bookConfig.watermarkWidth||100)*h,height:(bookConfig.watermarkHeight||50)*h,opacity:bookConfig.watermarkOpacity,spacing:(bookConfig.watermarkSpacing||50)*h,rotation:bookConfig.watermarkRotation,watermarkEdgeMargin:(bookConfig.watermarkEdgeMargin||12)*h,
watermarkImage:new Image};if(bookConfig.printWatermarkFile){if(k.watermarkImage.src=bookConfig.printWatermarkFile,k.watermarkImage.onload=function(){try{bookConfig.watermarkHeight||(k.height=k.width*k.watermarkImage.height/k.watermarkImage.width),e.applyWatermark(k),c(d)}catch(l){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",l),c(null)}},k.watermarkImage.complete)try{bookConfig.watermarkHeight||(k.height=k.width*k.watermarkImage.height/k.watermarkImage.width),e.applyWatermark(k),
c(d)}catch(l){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",l),c(null)}}else c(null)}catch(l){console.error("\u9352\u6d98\u7f13\u59d8\u6751\u5d43canvas\u6fb6\u8fab\u89e6:",l),c(null)}else c(null)})},getPrintImgType:function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return b="normal",e.yield(getPageDir(a,"thumb"),2);if(3!=e.nextAddress)return c=e.yieldResult,e.yield(getPageDir(a,"previewPage"),3);d=e.yieldResult;c.match(/none/)?
d.match(/none/)||(b="previewPage"):b="thumb";return e.return(b)})},getPages:function(a){if("all"==a){a=[];for(var b=1;b<=bookConfig.totalPageCount;b++)a.push(b);return a}return"current"==a?this.options.getCurrentPages?this.options.getCurrentPages():BookInfo.getCurrentPages():getPagesByRange(a)},initPrintEvent:function(){this.button.bind(_event._click,function(a){this.printType=this.button.printType;switch(this.printType){case "printAll":var b=this.getPages("all");this.printPages(b);break;case "printCurrent":b=
this.getPages("current");this.printPages(b);break;case "printRange":var c=$("#print_range_num").val();if(0>=parseInt(c))return;b=this.getPages(c);this.printPages(b)}if("printAll"===this.printType){var d="print_all_pages";var e="all pages"}else"printCurrent"===this.printType?(d="print_page_"+b.join("_"),e=b.join("_")):"printRange"===this.printType&&(a=c.replace(/,/g,"_"),d="print_page_"+a,e=a);BookEvent.trigger("customEvent",[d,{printed_page:e}]);BookEvent.trigger("print",[BookInfo.getCurrentPageIndex(),
"printAll"==this.printType?"all":b.join(","),this.printType])}.bind(this))},initPrintStack:function(a){window.printLoadStack&&(window.printLoadStack.destroy(),window.printLoadStack=null);window.printLoadStack||(window.printLoadStack=new PdfLoadArray(a.length))},initLoadPrint:function(){this.printLoad||(this.printLoad=$("<div class='posterContainer'></div>"),this.printLoad.css({display:"none","z-index":"10001",position:"absolute",left:"0",top:"0",width:"100%",height:"100%",background:"rgba(11,11,11,0.7)"}),
this.printLoad.bind("click",function(a){a.stopPropagation();window.printLoadStack&&window.printLoadStack.destroy();this.hidePrintLoading()}.bind(this)),this.loadingIcon=$("<img style='position:absolute;transform : translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);left : 50%;top : 50%;z-index:1112' src='"+uiBaseURL+"loading.gif' />"),this.printLoad.append(this.loadingIcon),this.parent.append(this.printLoad));this.showPrintLoading()},showPrintLoading:function(){this.printLoad&&this.printLoad.fadeIn(200)},
hidePrintLoading:function(){this.printLoad&&this.printLoad.fadeOut(200)}}),PrintElements=Class({create:function(a){this._super(a);this.printOnUrl=form_icons.print_on?"data:image/png;base64,"+form_icons.print_on:uiBaseURL+"print_on.png";this.printOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:uiBaseURL+"print_off.png";this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.rightToLeft?(this.printAll=$("<div class='printAll item button' print='printAll'><span class='title'>"+
getLanguage("frmPrintall","Print All Pages")+"</span><img src='"+this.printOffUrl+"'/></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span><img src='"+this.printOnUrl+"'/></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><input id='print_range_num' dir='rtl' placeholder='"+getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'></input><span class='title'>"+
getLanguage("frmPrintRange","Print Range")+"</span><img src='"+this.printOffUrl+"'/></div>")):(this.printAll=$("<div class='printAll item button' print='printAll'><img src='"+this.printOffUrl+"'/><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><img src='"+this.printOnUrl+"'/><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span></div>"),this.printRange=
$("<div class='printRange item button' print='printRange'><img src='"+this.printOffUrl+"'/><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+"'></input></div>"));this.printButton=$("<div class='printButton title button'>"+getLanguage("frmPrintbtn","Print")+"</div>");this.printButton.printType="printCurrent";this.analysis=new AnalysisPrint(this.printButton);this.pictureListForm=new PictureListForm},
pickElements:function(a){a.printOnUrl=this.printOnUrl;a.printOffUrl=this.printOffUrl;a.printAll=this.printAll;a.printCurrent=this.printCurrent;a.printRange=this.printRange;a.printButton=this.printButton;a.pictureListForm=this.pictureListForm},initEvent:function(a){this.printAll.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printCurrent.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printRange.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));
this.printRange.find("input").on("input propertychange change",function(){this.refreshPrintButton()}.bind(this));this.printRange.find("input").bind("mousedown touchstart pointerdown mouseover mousemove touchmove touchstend",function(b){b.stopPropagation()})},buttonEvent:function(a,b){var c=a.stage.find(".on");c.find("img").attr("src",this.printOffUrl);c.find("img")[0].colorChanged=!1;c.removeClass("on");$(b).find("img").attr("src",this.printOnUrl);$(b).find("img")[0].colorChanged=!1;$(b).addClass("on");
b=$(b).attr("print");a.printButton.printType=b;this.refreshPrintButton();a.changeItemColor()},refreshPrintButton:function(){"printRange"!=this.printButton.printType||$("#print_range_num").val()?this.lightPrintButton():this.darkPrintButton()},lightPrintButton:function(){$(this.printButton).addClass("usable");$(this.printButton).removeClass("disable");$(this.printButton).addClass("button_hover")},darkPrintButton:function(){"printRange"==this.printButton.printType&&($(this.printButton).removeClass("usable"),
$(this.printButton).removeClass("button_hover"),$(this.printButton).addClass("disable"))},changeLanguage:function(){this.printAll.find(".title").html(getLanguage("frmPrintall","Print All Pages"));this.printCurrent.find(".title").html(getLanguage("frmPrintcurrent","Print Current Pages"));this.printRange.find(".title").html(getLanguage("frmPrintRange","Print Range"));this.printRange.find("#print_range_num").attr("placeholder",getLanguage("frmPrintexample","Exzample:1,3-7,12"));this.printButton.html(getLanguage("frmPrintbtn",
"Print"))}}).extend(FormElements),PhonePrintElements=Class({create:function(a){this._super(a);this.printOnUrl=phoneBaseURL+"print_on_phone.png";this.printOffUrl=phoneBaseURL+"print_off_phone.png";this.fontColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.rightToLeft?(this.printAll=$("<div class='printAll item button' print='printAll'><span class='title'>"+getLanguage("frmPrintall",
"Print All Pages")+"</span><div class='print_icon'>"+this.getOffIcon()+"</div></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span><div class='print_icon'>"+this.getOnIcon()+"</div></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><div class='print_icon'>"+this.getOffIcon()+"</div><input id='print_range_num' dir='rtl' placeholder='"+getLanguage("frmPrintexample",
"Exzample:1,3-7,12")+"'></input><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span></div>")):(this.printAll=$("<div class='printAll item button' print='printAll'><div class='print_icon'>"+this.getOffIcon()+"</div><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><div class='print_icon'>"+this.getOnIcon()+"</div><span class='title'>"+getLanguage("frmPrintcurrent",
"Print Current Pages")+"</span></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><div class='print_icon'>"+this.getOffIcon()+"</div><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+"'></input></div>"));this.printButton=$("<div class='printButton title button' role='button'>"+getLanguage("frmPrintbtn","Print")+"</div>");this.printButton.printType="printCurrent";
this.analysis=new AnalysisPrint(this.printButton);this.pictureListForm=new PictureListForm},getOffIcon:function(){return'<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="\u9365\u60e7\u7730_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 48 48" style="enable-background:new 0 0 48 48;" xml:space="preserve"><path fill='+this.fontColor+' d="M23.6,8.3c-8.8,0-16,7.2-16,16c0,8.8,7.2,16,16,16c8.8,0,16-7.2,16-16S32.4,8.3,23.6,8.3L23.6,8.3z M23.6,38.3c-7.7,0-14-6.3-14-14c0-7.7,6.3-14,14-14c7.7,0,14,6.3,14,14C37.6,32.1,31.3,38.3,23.6,38.3L23.6,38.3z"/></svg>'},
...
c.length)return q.return();d=c.filter(function(t){return"mobile"===t.filter&&!isPC()||"pc"===t.filter&&isPC()?!1:!0});if(!d.length)return b.sharePanel.show(),null==(e=b.codeBox)||e.css({left:"50%",transform:"translateX(-50%)"}),a&&a(!0),q.return();b.loading=$('<img src="'+uiBaseURL+'loading.gif" style="position: absolute;left: 0;top: 0;right: 0;bottom: 0;margin: auto;"/>');$(b.sharePanel[0].parentElement.parentElement).append(b.loading);g={};for(f=0;f<d.length;g={$jscomp$loop$prop$obj$6:g.$jscomp$loop$prop$obj$6},
f++)g.$jscomp$loop$prop$obj$6=d[f],h=void 0,g.$jscomp$loop$prop$obj$6.type&&"copy"==g.$jscomp$loop$prop$obj$6.type?(h=$("<a aria-label='"+g.$jscomp$loop$prop$obj$6.title+"' tabindex='0' class='share-item' id='copy_url' data-clipboard-action='copy' title='"+g.$jscomp$loop$prop$obj$6.title+"'>\n            <img src='"+g.$jscomp$loop$prop$obj$6.logo+"'/>\n          </a>"),copyHref(h[0]),BookEvent.trigger("customEvent",["copy_share_link"])):h=-1<g.$jscomp$loop$prop$obj$6.url.indexOf("javascript")?$("<a data-type='"+
g.$jscomp$loop$prop$obj$6.type+"' aria-label='"+g.$jscomp$loop$prop$obj$6.title+"' tabindex='0' class='share-item' onclick='"+g.$jscomp$loop$prop$obj$6.url.remove("javascript:")+";return false;' title='"+g.$jscomp$loop$prop$obj$6.title+"'>\n            <img src='"+g.$jscomp$loop$prop$obj$6.logo+"'/>\n          </a>"):$("<a data-type='"+g.$jscomp$loop$prop$obj$6.type+"' aria-label='"+g.$jscomp$loop$prop$obj$6.title+"' tabindex='0' class='share-item' target = '_blank' href='"+g.$jscomp$loop$prop$obj$6.url+
"' title='"+g.$jscomp$loop$prop$obj$6.title+"'>\n            <img src='"+g.$jscomp$loop$prop$obj$6.logo+"'/>\n          </a>"),b.sharePanel.append(h),b.itemArray.push(h),k=b,h.bind(_event._end,function(t){return function(){var r=$(this).attr("title");BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),r,k.shareCurrentChecked]);r=t.$jscomp$loop$prop$obj$6.type;"share_more"==r&&(r="other_method");"twitter"==r&&(r="x");r&&BookEvent.trigger("customEvent",["click_share_with_"+r])}}(g));for(m=l=0;m<
b.itemArray.length;m++)p=b.itemArray[m],n=p.find("img")[0],n.onload=function(){l++;l==b.itemArray.length&&(b.loading.remove(),b.sharePanel.show(),a&&a())};q.jumpToEnd()})},initEvent:function(a){this.copy1.bind(_event._click,function(){BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),getLanguage("lblCopy","Copy"),self.shareCurrentChecked]);BookEvent.trigger("customEvent",["copy_share_link"]);this.copyFrom(this.linkArea)}.bind(this));this.linkArea.bind(_event._click,function(){this.linkArea.select()}.bind(this));
...
3);2!=k.nextAddress&&(c=k.yieldResult);d=c;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$8:e.$jscomp$loop$prop$type$8},g++)f=a.itemArray[g],e.$jscomp$loop$prop$type$8=f.attr("data-type"),(h=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$8}}(e)))&&(-1<h.url.indexOf("javascript")?f.attr("onclick",h.url.remove("javascript:")+";return false;"):f.attr("href",h.url));k.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=
...
getLanguage("btnBack",a);this.back=$("<div class='back'><img src='"+(window.zoom_icons&&zoom_icons["arrow-left"]?"data:image/png;base64,"+zoom_icons["arrow-left"]:uiBaseURL+"arrow-left.png")+"'/><span>"+a+"</span></div>");this.stage.append(this.back);this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.qrcode);this.hideQRCode()},initSwiper:function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==
c.nextAddress)return a.shareSwiper=$("<div class='shareSwiper stage'></div>"),a.shareSwiperList=$("<div class='swiper'></div>"),c.yield(a.analysisShare.getList(),2);b=c.yieldResult;if(!b||0>b.length)return c.return();a.refreshSwiper(a.shareSwiperList,b);a.shareSwiper.append(a.shareSwiperList);isPhone()||isPad()?a.shareSwiper.css({"overflow-y":"auto","overflow-x":"hidden","-webkit-overflow-scrolling":"touch"}):(a.shareSwiper.css({overflow:"hidden"}),a.shareSwiperList.css({top:0,left:0,width:"100%",
position:"absolute"}),a.progress=$("<div class='progress'></div>"),a.progressBar=$("<div class='progressBar'></div>"),a.shareSwiper.append(a.progress),a.progress.append(a.progressBar),a.shareSwiper.scroll({},Direction.top));a.stage.append(a.shareSwiper);c.jumpToEnd()})},refreshSwiper:function(a,b){for(var c=b.length,d=0;d<c;d++)this.addItem(a,b[d])},addItem:function(a,b){b&&(b.fontColor=this.fontColor,b=new PhoneShareItem(b),b.appendTo(a),this.items.push(b))},refresh:function(){isPhone()||isPad()||
!this.shareSwiper||this.shareSwiper.refreshData()},initEvent:function(){this.back.onTap(function(){this.hideQRCode()}.bind(this))},onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.shareSwiper||this.initSwiper()},onResize:function(){this._super();this.refresh()},showQRCode:function(){this.shareSwiper&&this.shareSwiper.hide();this.back.show();this.qrcode.show();$(this.back.find("img")).changeButtonColor(this.fontColor)},
...
a.find(".edit").attr("title",getLanguage("lblEdit","Edit"));a.find(".delete").attr("title",getLanguage("lblDelete","Delete"))}}).extend(FormElements),BookmarkItem=Class({create:function(a,b){this.callback=b;this.parm={color:a.color,caption:a.caption,pageIndex:parseInt(a.pageIndex)};this.item=$("<div class='item' pageIndex='"+parseInt(a.pageIndex)+"' id='bookmark_item"+parseInt(a.pageIndex)+"'></div>");this.saveUrl=form_icons.save?"data:image/png;base64,"+form_icons.save:uiBaseURL+"save.png";this.cancelUrl=
form_icons.cancel?"data:image/png;base64,"+form_icons.cancel:uiBaseURL+"cancel.png";this.editUrl=form_icons.edit?"data:image/png;base64,"+form_icons.edit:uiBaseURL+"edit.png";this.deleteUrl=form_icons["delete"]?"data:image/png;base64,"+form_icons["delete"]:uiBaseURL+"delete.png";this.fontColor=a.fontColor;this.color=a.color;this.caption=a.caption;this.pageCaption=getShownPageNumber(parseInt(a.pageIndex));this.pageIndex=parseInt(a.pageIndex);this.colorObj=Color(this.fontColor);this.initDefaultDom();
this.initHtml();this.initEvent()},resetColor:function(a){this.fontColor=a;this.colorObj=Color(this.fontColor)},initHtml:function(){rightToLeft?this.initRightToLeftHtml():this.initLeftToRightHtml();this.deleteIcon.changeButtonColor(this.fontColor);this.edit.changeButtonColor(this.fontColor);this.cancel.changeButtonColor(this.fontColor);this.save.changeButtonColor(this.fontColor)},initRightToLeftHtml:function(){this.item.append(this.deleteIcon);this.item.append(this.edit);this.item.append(this.cancel);
this.item.append(this.save);this.item.append(this.title);this.item.append(this.colorSelection);this.item.append(this.page)},initLeftToRightHtml:function(){this.item.append(this.page);this.item.append(this.title);this.item.append(this.colorSelection);this.item.append(this.save);this.item.append(this.cancel);this.item.append(this.edit);this.item.append(this.deleteIcon)},initDefaultDom:function(){this.page=$("<span class='page'>"+this.pageCaption+"</span>");this.title=$("<input class='title' title='"+
this.caption+"' value='"+this.caption+"' disabled='disabled'></input>");this.colorSelection=$("<input class='colorSelection' readonly type='text' style='background:"+this.color+"'></input>");this.colorSelection.attr("color",this.color);this.save=$("<img class='save' title='"+getLanguage("lblSave","Save")+"' src='"+this.saveUrl+"'/>");this.cancel=$("<img class='cancel' title='"+getLanguage("lblCancel","Cancel")+"' src='"+this.cancelUrl+"'/>");this.edit=$("<img class='edit' title='"+getLanguage("lblEdit",
"Edit")+"' src='"+this.editUrl+"'/>");this.deleteIcon=$("<img class='delete' title='"+getLanguage("lblDelete","Delete")+"' src='"+this.deleteUrl+"'/>");this.title.css({color:this.fontColor})},appendTo:function(a){a.append(this.item)},insertBefore:function(a){this.item.insertBefore(a)},insertAfter:function(a){this.item.insertAfter(a)},initEvent:function(){this.edit.onTap(function(){this.startEdit()}.bind(this));this.cancel.onTap(function(){this.endEdit();this.cancelData()}.bind(this));this.save.onTap(function(){this.endEdit();
this.saveData()}.bind(this));this.deleteIcon.onTap(function(){this.item.remove();this.callback.deleteItem(this.parm.pageIndex)}.bind(this));this.item.onTap(function(){this.judgeToSaveOrCancel();gotoPageFun(this.pageIndex,!1,"bookmark");BookEvent.trigger("customEvent",["click_bookmark_on_panel_to_"+this.pageIndex,{click_bookmark_on_panel_to:this.pageIndex}])}.bind(this));this.title.bind("keypress",function(a){"13"==a.keyCode&&(this.endEdit(),this.saveData())}.bind(this));this.item.bind("mouseover",
...
a.image=$("<div class='thumbnail' style='display: inline-block;background:"+bookConfig.pageBackgroundColor+";width:60px;'></div>"):a.image=$("<img class='thumbnail' src='"+b+"'/>");isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||a.image.css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&a.image.css({"pointer-events":"none"});a.item.append(a.image)})}}),AnalysisBookmark=Class({create:function(){this.bookmarkList=[];this.bookmarkDetaildList=[];this.key=window.location.href.replace(window.location.hash,
"").replace(window.location.search,"")+"BookMark";this.refresh()},refresh:function(){var a=this.getListFromLocalStorage();if(a&&0!=a.length){for(var b=0;b<a.length;b++)parseInt(a[b].pageIndex)&&this.bookmarkList.push(parseInt(a[b].pageIndex));this.bookmarkDetaildList=a}},getListFromLocalStorage:function(){var a=this.getLocalStorage(this.key);return Instance.parse(a)},getList:function(){return this.bookmarkList},getItem:function(a){for(var b,c=0;c<this.bookmarkDetaildList.length;c++)if(parseInt(this.bookmarkDetaildList[c].pageIndex)==
parseInt(a)){b=this.bookmarkDetaildList[c];break}return b},editItem:function(a){for(var b=a.pageIndex,c=0;c<this.bookmarkDetaildList.length;c++)if(parseInt(this.bookmarkDetaildList[c].pageIndex)==parseInt(b)){this.bookmarkDetaildList[c].caption=a.caption;this.bookmarkDetaildList[c].color=a.color;break}this.refreshLocalStorage()},addItem:function(a){var b=a.pageIndex;0>this.bookmarkList.indexOf(b)&&(this.bookmarkList.push(b),this.bookmarkDetaildList.push(a),this.sortList())},deleteItem:function(a){for(var b=
...
setTimeout(function(){$("body").css({transform:"translate(0px, 0px) rotate(0deg)"})},300)}}).extend(FadeOutFadeForm),VideoGalleryItem=Class({create:function(a,b){a&&(this.parm=a,this.callback=b,this.initDom(),this.initEvent())},initDom:function(){this.item=$("<div class='item'></div>");this.image=$("<div class='thumbnail'></div>");this.parm.thumbnail&&this.image.css({"background-image":"url("+this.parm.thumbnail+")"});this.parm.title&&(this.title=rightToLeft?$("<div class='title rtl'>"+this.parm.title+
"</div>"):$("<div class='title'>"+this.parm.title+"</div>"));this.parm.description&&(this.description=rightToLeft?$("<div class='description rtl'>"+this.handleData(this.parm.description)+"</div>"):$("<div class='description'>"+this.handleData(this.parm.description)+"</div>"));this.item.append(this.image);this.title&&this.item.append(this.title);this.description&&this.item.append(this.description)},handleData:function(a){a=a.replaceAll("<","&lt");a=a.replaceAll(">","&gt");return a=handleData(a,"")},
initEvent:function(){this.item.onTap(this.callback)},getDom:function(){return this.item}}),PhotoGallery=Class({create:function(a,b){!b||0>=b.length||(this.parent=a,this.photoArray=b,this.index=0,this.visible=!1,this.pageWidth=$(window).width(),this.pageHeight=$(window).height(),this.images=[],this.thumbnails=[],this.initHtml(),this.initEvent())},initHtml:function(){this.leftBtnUrl=uiBaseURL+"photo_prev.png";this.rightBtnUrl=uiBaseURL+"photo_next.png";this.closeBtnUrl=uiBaseURL+"photoGallery_close.png";
this.stage=$("<div class='photogallery' style=\"display:none\"></div>");this.close=$("<div tabindex='0' class='close'><img alt='close' width='auto' height='auto' src=\""+this.closeBtnUrl+'" /></div>');this.stage.append(this.close);this.initImgThumb();this.initImgContainer();this.initImages();this.setThumbnal();this.setPhotoImage();this.imgChange();this.parent.append(this.stage);this.images[0].css({display:"block"})},initImgContainer:function(){this.imgContainer=$("<div class='imgContainer'></div>");
this.leftBtn=$("<div class='leftBtn'><img src=' "+this.leftBtnUrl+"' /></div>");this.rightBtn=$("<div class='rightBtn'><img src='"+this.rightBtnUrl+"'/></div>");this.containerBG=$("<div class='photoBG'></div>");this.imgContainer.append(this.leftBtn);this.imgContainer.append(this.rightBtn);this.stage.append(this.imgContainer).append(this.containerBG)},initImgThumb:function(){this.thumbContainer=$("<div class='thumbContainer'></div>");this.stage.append(this.thumbContainer)},initEvent:function(){var a=
this;this.stage.bind("mousedown touchstart",function(b){b.stopPropagation()});1<this.photoArray.length&&(this.imgContainer.bind("mouseenter",function(){this.leftBtn.animate({left:"0"},300);this.rightBtn.animate({right:"0"},300)}.bind(this)),this.imgContainer.bind("mouseleave",function(){this.leftBtn.animate({left:"-32px"},300);this.rightBtn.animate({right:"-32px"},300)}.bind(this)));this.imgContainer.bind("click",function(b){this.moving||(b.stopPropagation(),this.stopAutoPlay(),this.index+=1,this.index>
...
function resizeComponents(){if(global.printBody)printBody.onResize();if(global.downLoadBody)downLoadBody.onResize();if(global.helpBody)helpBody.onResize();if(global.aboutBody)aboutBody.onResize();if(global.sharePanel)sharePanel.onResize();if(global.languagePanel)languagePanel.onResize();if(global.frmTableOfContent)frmTableOfContent.onResize();if(global.bookmark)bookmark.onResize()};var PcAboutForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super();this.bookReadTimesVisible()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.9),color:this.fontColor});this.content.css({"background-color":this.mainColor,color:this.fontColor});this.titleList.find(".focus").css("border-bottom","2px solid "+this.fontColor)},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):
this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='about_content'></div>");this.initTitleList();this.stage.append(this.content);this.content2=$("<div class='content2' style='display:none'></div>");this.content.append(this.content2);this.content1=$("<div class='content1'></div>");this.content.append(this.content1);this.content1.append(this.author);this.content1.append(this.address);this.content1.append(this.email);this.content1.append(this.website);this.content1.append(this.mobile);
this.initSwiper();this.initLogo();this.content2.append(this.aboutSwiper);this.content2.append(this.logo);bookConfig.CompanyLogoFile||this.aboutSwiper.css({width:"100%"});this._super()},bookReadTimesVisible:function(){var a=setInterval(function(){try{this.ReadTimes=global.aboutReadTimes?global.aboutReadTimes:0,0<this.ReadTimes?(this.content1.css("height","249px"),this.content1.append(this.views),clearInterval(a)):10<this.elements.iRead&&clearInterval(a)}catch(b){}}.bind(this),1E3)},initTitleList:function(){this.titleList=
$("<div class='title_list'></div>");this.titleList.append(this.descriptionTitle);this.titleList.append(this.contactTitle);(bookConfig.CompanyLogoFile||bookConfig.AboutDescription)&&this.content.append(this.titleList)},initLogo:function(){bookConfig.CompanyLogoFile||bookConfig.AboutDescription?(this.content.find(this.titleList)[0]||this.content.prepend(this.titleList),this.content.find(".focus")[0]||this.contactTitle.css("border-bottom","2px solid "+this.fontColor),this.content.find(this.content2)[0]||
this.content.append(this.content2),bookConfig.CompanyLogoFile&&!this.content2.find(this.logo)[0]&&this.content2.prepend(this.logo),bookConfig.AboutDescription&&this.aboutSwiper&&this.aboutSwiper.refreshData(),bookConfig.CompanyLogoFile?bookConfig.AboutDescription?(this.aboutSwiper.css({width:"300px"}),this.logo.css({width:""})):this.logo.css({width:"100%"}):this.aboutSwiper.css({width:"100%"}),this.aboutSwiper.refreshData()):(this.content.find(this.content2)[0]&&this.content2.remove(),this.content.find(this.titleList)[0]&&
this.titleList.remove(),this.showContact())},initSwiper:function(){this.aboutSwiper=$("<div class='aboutSwiper stage'></div>");this.aboutSwiperList=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.aboutSwiper.append(this.aboutSwiperList);this.aboutSwiperList.append(this.description);this.aboutSwiper.append(this.progress);this.progress.append(this.progressBar);bookConfig.CompanyLogoFile&&this.aboutSwiper.css({width:"310px"});
this.aboutSwiper.scroll({},Direction.top,"win10")},showContact:function(){this.descriptionTitle.removeClass("focus");this.contactTitle.addClass("focus");this.descriptionTitle.css("border-bottom","none");this.contactTitle.css("border-bottom","2px solid "+this.fontColor);this.content1.show();this.content2.hide()},showDescription:function(){this.contactTitle.removeClass("focus");this.descriptionTitle.addClass("focus");this.descriptionTitle.css("border-bottom","2px solid "+this.fontColor);this.contactTitle.css("border-bottom",
"none");this.content2.show();this.aboutSwiper.refreshData();this.content1.hide()},onShow:function(){this._super();this.aboutSwiper.refreshData()}}).extend(PcAboutFrame);var PcBookmarkItem=Class({create:function(a,b){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;a.fontColor=this.fontColor;this._super(a,b)}}).extend(BookmarkItem);var PcBookmarkListPanel=Class({create:function(a){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor);this._super(a)},onCreate:function(){this.progressBar.css({"background-color":this.fontColor})},newItem:function(a){return new PcBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel);var PcBookmarkForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this._super();this.stage.css({"background-color":this.mainColorObj.rgba(.9),color:this.fontColor});this.content.css({padding:"0 10px"});this.leftAddPage.css({"background-color":this.mainColor,color:this.fontColor});this.rightAddPage.css({"background-color":this.mainColor,color:this.fontColor});this.remove.css({"background-color":this.fontColor,color:this.mainColor});this.bookmarkListTitle.css({"background-color":this.mainColorObj.rgba(.6),
color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='bookmark_content'></div>");this.stage.append(this.content);var a=$("<p class='inputForm'></p>");a.append(this.input);a.append(this.colorSelection);this.content.append(a);this.content.append(this.leftAddPage);this.content.append(this.rightAddPage);this.content.append(this.bookmarkListTitle);
this.content.append(this.bookmarkListPanel.bookmarkSwiper);this.content.append(this.remove);this.parent.append(this.stage);this.refreshPanel()}}).extend(PcBookmarkFrame);var PcHelpForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.9),color:this.fontColor});this.content.css({"background-color":this.mainColor,color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='help_content'></div>");
this.stage.append(this.content);this.content.append(this.image);this.title1&&this.content.append(this.title1);this.title2&&this.content.append(this.title2);this._super()}}).extend(PcHelpFrame);var PcPrintForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.9*this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);
this.content=$("<div class='content'></div>");this.stage.append(this.content);this.content.append(this.pictureListForm.getDom());var a=$("<div class='printDiv'></div>");this.appendPrintOptions(a);this.content.append(a);this.initMoreEvent();this._super()},initMoreEvent:function(){this.printRange.find("#print_range_num").bind("focus",function(){$(this).css({opacity:1})});this.printRange.find("#print_range_num").bind("blur",function(){ifRegNull=!/(^\s+)|(\s+$)/g.test($(this).val());""!==$(this).val()&&
ifRegNull?$(this).css({opacity:1}):$(this).css({opacity:.7})})},onShow:function(){passwardType()&&verifyPassward()&&this.pictureListForm.fillContent(BookInfo.getBook().getCurrentPageIndex());this._super()}}).extend(PcPrintFrame);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.9*this.formOpacity),color:this.fontColor});this.progressBar.css({"background-color":this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='tableofcontent_content'></div>");
this.stage.append(this.content);this.content.append(this.tableofcontentSwiper);this.parent.append(this.stage)},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=300;this.height=a-87;this.maxHeight=this.height-38;this.stage.css({height:this.height+"px",top:b+"px"});this.tableofcontentSwiper.css({height:this.maxHeight+"px"});this.elements.refresh()}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.9),color:this.fontColor});this.title.css({"background-color":"transparent",color:this.fontColor});this.content.css({"background-color":this.mainColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);
this.content.append(this.video);this.content.append(this.info);if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);this.content.append(a)}else this.stage.css("width","335px");this.stage.append(this.content);this._super()}}).extend(PcVideoGalleryFrame);var PcShareForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.elements.fontColor=this.fontColor;this.stage.css({"background-color":this.mainColorObj.rgba(.9*this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor})},initSwiper:function(){this.swiperContainer=$("<div class='swiperContainer'></div>");this.shareStage=$("<div class='shareStage stage'></div>");
this.shareSwiper=$("<div class='shareSwiper swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.shareSwiper.append(this.sharePanel);this.shareStage.append(this.shareSwiper);this.shareStage.append(this.progress);this.progress.append(this.progressBar);this.swiperContainer.append(this.shareStage);this.shareStage.scroll({},Direction.top,"win10")},initHtml:function(){var a=this;this.stage.addClass("win10_border");this.stage.append(this.title);
this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='share_content'></div>");this.initSwiper();this.stage.append(this.content);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);this.getQrCodeStatus().then(function(b){b&&a.content.append(a.codeBox)}).catch(function(b){console.error("Error getting QR code status:",b)});this.swiperContainer.append(this.sharePanelTitle);
this.content.append(this.swiperContainer);this.linkBox.append(this.linkArea).append(this.copy1);this.content.append(this.shareCurrentPageBox);this.content.append(this.linkBox);this._super()}}).extend(PcShareFrame);var PcDownloadForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.9*this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor})},resetColorChanged:function(){this._super();this.dragIcon[0].colorChanged=!1},resetIconSrc:function(){this._super();this.dragIcon.attr("src",this.dragUrl)},changeIconColor:function(){this._super();
this.dragIcon.changeButtonColor(this.fontColor);this.changeItemColor()},changeItemColor:function(){this.downloadCurrent.changeButtonColor(this.fontColor);this.downloadAttachments.changeButtonColor(this.fontColor);this.downloadAll.changeButtonColor(this.fontColor);this.pictureListForm.leftBtn.changeButtonColor(this.fontColor);this.pictureListForm.rightBtn.changeButtonColor(this.fontColor)},initHtml:function(){this.dragUrl=form_icons.drag?"data:image/png;base64,"+form_icons.drag:uiBaseURL+"drag.png";
this.dragIcon=$("<img alt='drag' width='auto' height='auto' class='drag' src='"+this.dragUrl+"'/>");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.title.append(this.close);this.content=$("<div class='content'></div>");this.content1=$("<div class='content1'></div>");downloadconfig.pdf&&this.content1.append(this.downloadAll);downloadconfig.hideDownloadSinglePage||this.content1.append(this.downloadCurrent);downloadconfig.attachments&&
0<downloadconfig.attachments.length&&(this.content1.append(this.downloadAttachments),this.content1.append(this.selectAttachments));this.hasFiles?this.content1.append(this.downloadButton):this.content1.append(this.noFilesAvailablePrompt);this.content2=$("<div class='content2'></div>");this.content2.append(this.pictureListForm.getDom());this.content.append(this.content1);this.content.append(this.content2);this.stage.append(this.content);this._super()},gotoPage:function(a){this.pictureListForm.fillContent(a)}}).extend(PcDownloadFrame);
